...
import com.ytjj.function.TableProcessFunction;
import com.ytjj.sink.DimSink;
...
public class ProcessMysqlBinlog {
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<JSONObject> kafka = connectedStream.process(new TableProcessFunction(mapStateDescriptor, hbaseTag));
